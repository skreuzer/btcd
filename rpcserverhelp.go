...
var helpDescsEnUS = map[string]string{
	...
	"getmempoolinforesult-maxmempool":    "Maximum memory usage for the mempool",
	"getmempoolinforesult-mempoolminfee": "Minimum fee rate in BTC/kB for tx to be accepted. Is the maximum of minrelaytxfee and minimum mempool fee",
